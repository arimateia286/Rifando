...
let rifa = localStorage.getItem(actualRifaName)
  ? JSON.parse(localStorage.getItem(actualRifaName))
  : {
...
const borderColorButton = colorButton(
  "border-color-button",
  "da borda",
  "borderColor",
);
const backColorButton = colorButton(
  "back-color-button",
  "do fundo",
  "backColor",
);
const fontColorButton = colorButton(
  "font-color-button",
  "da fonte",
  "fontColor",
);
...
function changePointStyle() {
  ...
  for (let rifaPoint of rifaPoints) {
    ...
    if (rifaPoint.classList.contains("sold")) {
      ...
      if (rifa["borderColor"] == rifa["fontColor"])
        rifaPoint.style.background = "red";
    } else {
...
configButton.addEventListener("click", () => {
  if (buttonContainer.classList.contains("hidden")) {
    configButton.innerHTML = `<i class="fa-solid fa-xmark"></i>`;
    buttonContainer.classList.remove("hidden");
    clearInterval(fadeTimer);
  } else {
    sliderBtnArr.forEach((e) => e.classList.remove("chosen"));
    configButton.innerHTML = `<i class="fa-solid fa-cog"></i>`;
...
amountButton.addEventListener("click", () => {
  ...
  prompt("De quantos pontos será a rifa?").then((amount_) => {
    let amount = parseInt(amount_);
    if (amount && !isNaN(amount)) {
      prompt("Quantos pontos mostrar por página?").then((points_) => {
...
toggleViewButton.addEventListener("click", () => {
  ...
  if (isTableView) {
    ...
    toggleViewButton.innerHTML = '<i class="fa-solid fa-ticket icon"></i>Rifa';
    ...
    toggleViewButton.innerHTML = '<i class="fa-solid fa-table icon"></i>Tabela';
